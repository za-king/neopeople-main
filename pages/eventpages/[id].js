...
export const getStaticProps = async (context) => {
  ...
  const getdata = await fetch(`http://104.199.125.194:3001/events/` + id);
...
export const getStaticPaths = async () => {
  const res = await fetch(`http://104.199.125.194:3001/events`);
              ...
              <>
                <div className="flex item-center justify-center  space-between ">
                  <div className="flex w-1/2  justify-center  ">
                    <img src={x.cover} width={540} height={665} alt="" />
                  </div>
                      ...
                      <SwiperSlide>
                        <div className="bg-[#F2F2F2] w-[540px] h-[665px] rounded-xl ">
                          ...
                          <div className="flex justify-center py-10  ">
                            ...
                            <div>E-SERTIFIKAT ILMU & PENGETAHUAN KOMUNITAS</div>
                          </div>
