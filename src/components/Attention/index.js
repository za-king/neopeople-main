...
export default function Attention() {
    return (
        <div className=" flex bg-[#FF5800] h-[40vh] justify-center items-center flex-col" >
            <Fade bottom>
            <div className="text-6xl font-sans font-thin">
                Attention
                </div>
            </Fade>
                ...
                segera konsultasikan apa yang sedang kamu rasakan ke
                tenaga profesional atau telfon ke 119 untuk panggilan darurat.
            </div>
                </Fade>
